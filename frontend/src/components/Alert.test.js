...
describe('Alert', () => {
  ...
  it('applies error styles for type=error', () => {
    ...
    expect(container.firstChild).toHaveClass('bg-red-50/95');
  ...
  it('applies success styles for type=success', () => {
    ...
    expect(container.firstChild).toHaveClass('bg-emerald-50/95');
  ...
  it('applies warning styles for type=warning', () => {
    ...
    expect(container.firstChild).toHaveClass('bg-amber-50/95');
  ...
  it('applies info styles for type=info', () => {
    ...
    expect(container.firstChild).toHaveClass('bg-sky-50/95');
