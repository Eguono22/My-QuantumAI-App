...
export const API_BASE_URL = process.env.REACT_APP_API_URL || globalConfig.apiBaseUrl || (isLocalDev ? 'http://127.0.0.1:8011' : '/api');
export const WS_BASE_URL = process.env.REACT_APP_WS_URL || (hasWindow ? (isLocalDev ? 'ws://127.0.0.1:8011/ws' : `${wsProtocol}://${window.location.host}/api/ws`) : 'ws://127.0.0.1:8011/ws');
