...
export const API_BASE_URL = process.env.REACT_APP_API_URL || globalConfig.apiBaseUrl || (isLocalDev ? 'http://localhost:8002' : '/api');
export const WS_BASE_URL = process.env.REACT_APP_WS_URL || (hasWindow ? (isLocalDev ? 'ws://localhost:8002/ws' : `${wsProtocol}://${window.location.host}/api/ws`) : 'ws://localhost:8002/ws');
