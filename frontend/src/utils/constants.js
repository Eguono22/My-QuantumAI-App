...
export const WS_BASE_URL = process.env.REACT_APP_WS_URL || (hasWindow ? (isLocalDev ? 'ws://localhost:8002/ws' : `${wsProtocol}://${window.location.host}/ws`) : 'ws://localhost:8002/ws');
