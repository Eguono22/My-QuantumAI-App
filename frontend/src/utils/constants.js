...
export const API_BASE_URL = process.env.REACT_APP_API_URL || (isLocalDev ? 'http://localhost:8002' : '/api');
export const WS_BASE_URL = process.env.REACT_APP_WS_URL || (hasWindow ? (isLocalDev ? 'ws://localhost:8002' : `${wsProtocol}://${window.location.host}/ws`) : 'ws://localhost:8002');
